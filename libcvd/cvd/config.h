...
#endif
#ifndef CVD_DISABLE_HALFSAMPLE_MMX8
    #define CVD_INTERNAL_HAVE_HALFSAMPLE_MMX8 1
#endif
...
#define CVD_KERNEL_MAJOR uname 
#define CVD_KERNEL_MINOR r
#define CVD_KERNEL_RELEASE 
